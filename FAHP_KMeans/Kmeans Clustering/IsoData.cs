...
//	public isodata(String inFile,boolean loadOld,int K,int I,int P, int On,double Os,double Oc)throws Exception{
	...
	public isodata(String inFile,String nameIndexFile,String subsetFile,bool double_reduce){
		if (double_reduce) {
...
//				System.out.println("clustAVG\t"+tDouble/curClust.size());
	...
	public void analyzeClusters(String clusterFile,String outPrefix){
