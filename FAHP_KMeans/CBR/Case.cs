...
/// <summary>
	...
	public class Case
	{
        ...
        public Dictionary<Feature, FuzzyNumber> features_fuzzy_numbers;
        ...
        public void CreateFeaturesFuzzyNumbers()
        {
            if (_featureList!= null){
                features_fuzzy_numbers = new Dictionary<Feature, FuzzyNumber>();
            }
        }
       ...
       public FuzzyNumber GetFeatureFuzzyNumber(Feature feature)
       {
           if (features_fuzzy_numbers.ContainsKey(feature))
               return features_fuzzy_numbers[feature];
           else
               return null;
       }
