...
using System;
	...
	public class DefaultOCBRFile:IOCBRFile
	{
        ...
        private List<Case> _list_cases = null;
        ...
        private static bool _with_id = false;
        int feasture_id = 0;
		public DefaultOCBRFile()
		{
			_cases = new ArrayList();
			_features = new ArrayList();
            _list_cases = new List<Case>();
		}
        ...
        public string[] GetFeatureNames()
       {
        ...
        public DefaultOCBRFile(string path, bool with_id)
        {
            _path = path;
            _cases = new ArrayList();
            _features = new ArrayList();
		...
		private void ParseFeature(string token)
		{
            ...
            string unit = featureProperties[4];
            unit = unit.Trim();
			Feature f = new Feature(name, typeValue, null, weightValue,
                                    isKeyValue, isIndexValue, unit);
			_features.Add(f);
